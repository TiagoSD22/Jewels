...
public class Level1{
    ...
    public void GameOver(){
    	if(jogo.GameOver() || pontuacao >= 1000){
    		som.Parar("lvl1");
    		fim.setVisible(true);
    		if(jogo.GameOver()){
						...
						if(!b1){
							...
							if(!b2){
								...
								if(jogo.PodeTrocarPecas(ib1,jb1,ib2,jb2)){
									...
									jogo.AcrescentarNovosBlocos(background,7);
									som.Tocar("queda");
									DesenharTabuleiro();
	...
	private void initialize() {
		...
		inicio = new JFrame("Level 1");
		inicio.setBounds(450, 300, 400, 200);
		inicio.setLayout(null);
		inicio.setVisible(true);
		
		JLabel infolvl = new JLabel("Faça 1000 pontos para ganhar!");
